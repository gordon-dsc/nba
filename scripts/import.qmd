...
initial |>
  ...
  initial
Sys.sleep(60)
for (i in 1981:2020) { #for ever year from 1981 to 2020 excluding 1999 add the information to the data frame
  if (i == 1999) {
    Sys.sleep(60)
    next 
  }
...
# Bobby Jones 1981 and 1982 id 2277 
# Patrick Ewing 1988 1989 id: 2964
# Kareem Abdul Jabar id: 2247 
# players that did not play 2019(Kevin Durnat, Klay Thompson, Dwayne Wade, Dirk Nowitzki)
# 1991 Magic Johnson retired
# Kobe Bryant 2016 retired (2015)
# Tim Hardaway id: 576  yr 1993
# 1993 Michael Jordan retired
# 2012 Andrew Bynum was injured
# Steve Smith 1998 first name Steven id: 675
# 2012 Derick Rosen tore ACL
# Meta World peace id: 1249 yr2004
# Yao Ming did not play 2009 full season

```

```{r}
temp5 <- data_func(2009)
  temp5 |>
    mutate(last = case_when(temp5$last == "Dončić"~ "Doncic",
                            temp5$last == "Jokić" ~ "Jokic",
                            temp5$last == "Vučević" ~ "Vucevic",
                            temp5$last == "Dragić" ~ "Dragic",
                            temp5$last == "Ginóbili" ~ "Ginobili",
                            TRUE ~ temp5$last)) -> temp5
     
  temp5 |>
    mutate(stats = map2(.x = as.character(temp5$first),
                        .y = as.character(temp5$last),
                        .f = \(x,y) {get_season_avg(x,y,2009)},
                        .progress = TRUE)) |>
    unnest_wider(stats) ->
    temp5
```
